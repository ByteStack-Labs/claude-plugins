...
| **calibration-guard**  | Catch confident-but-wrong before it ships.           | Whether stated confidence still tracks accuracy once the input distribution shifts, and catches the failures a confidence threshold alone misses.                                          | shipped — `calibration-guard`  |
